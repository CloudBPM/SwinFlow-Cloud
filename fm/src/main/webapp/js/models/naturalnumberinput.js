...
function NaturalNumberInput() {
    ...
    this.appendType = "Icon"; // No; Text; Icon prepend;
    this.append = "fa-plus";
    this.classtypename = "NaturalNumberInput";
...
NaturalNumberInput.prototype = new UIComponent();

// for previewing
NaturalNumberInput.prototype.clone = function () {
    var t = new NaturalNumberInput();
    t.id = this.id;
...
// for previewing
NaturalNumberInput.prototype.cloneRules = function (owner, old) {
    this.f = owner;
...
// for previewing
NaturalNumberInput.prototype.toDomForHTML = function(parent) {
...
NaturalNumberInput.prototype.toDom = function (parent) {
    this.toDomforFormGroup(parent);
    this.updateDom();
};

NaturalNumberInput.prototype.updateDom = function () {
    ...
    if (this.readOnly == 0) {
        ...
        if (this.prependType != "No" || this.appendType != "No") {
            ...
            if (this.prependType == "Text") {
                ...
                groupPreAddOn.className = "input-group-addon";
                if (this.disabled == 0) {
                    groupPreAddOn.addEventListener("click", function () {
            ...
            if (this.appendType == "Text") {
                ...
                groupPostAddOn.className = "input-group-addon";
                if (this.disabled == 0) {
                    groupPostAddOn.addEventListener("click", function () {
                        var v = parseInt(input.value);
                        input.value = "" + (v + 1);
                        input.dispatchEvent(new Event('change'));
                    });
...
NaturalNumberInput.prototype.updateValueforRuntime = function () {
    var o = document.getElementById("natural" + this.id);
    o.value = this.initValue;
};

NaturalNumberInput.prototype.editable = function (e) {
    var o = document.getElementById("natural" + this.id);
    if (e == "0") {
        o.readOnly = false;
    } else {
...
NaturalNumberInput.prototype.show = function (d) {
    if (this.f != undefined) {
...
NaturalNumberInput.prototype.enable = function (e) {
    if (this.f != undefined) {
        var o = this.f.seekObjectByID(this.id);
        var i = o.input;
        if (e == "1") {
...
NaturalNumberInput.prototype.toDomforFormGroup = function (parent) {
    this.dom = document.createElement("DIV");
    parent.appendChild(this.dom);
    this.dom.id = this.id;
...
NaturalNumberInput.prototype.toRealValue = function () {
    var input = document.getElementById("natural" + this.id);
...
NaturalNumberInput.prototype.handleEvent = function (e) {
    switch (e.type) {
...
NaturalNumberInput.prototype.doClick = function (evt) {
    if (this.evn == 0) {
...
NaturalNumberInput.prototype.doFocus = function (evt) {
    this.doHandle(evt, 4);
...
NaturalNumberInput.prototype.doBlur = function (evt) {
    this.doHandle(evt, 5);
...
NaturalNumberInput.prototype.doChange = function (evt) {
    if (this.evn == 0) { // build time
        this.doHandle(evt, 2);
        var e = document.getElementById("natural" + this.id);
        if (evt.target == e) {
            map[this.currOwner].stack.execute(new FMUIValueChangedCmd(this,
                "initValue", e.value, this.currOwner));
        }
    } else if (this.evn == 1) { // runtime
...
NaturalNumberInput.prototype.doSelect = function (evt) {
    this.doHandle(evt, 3);
    Utils.stopBubble(evt);
};

NaturalNumberInput.prototype.doInput = function (evt) {
    this.doHandle(evt, 1);
    Utils.stopBubble(evt);
};

NaturalNumberInput.prototype.doKeypress = function (evt) {
    var o = document.getElementById("natural" + this.id);
    Utils.blockNonNumbers(o, evt, false, false);
    Utils.stopBubble(evt);
};

NaturalNumberInput.prototype.doPaste = function (evt) {
    Utils.stopDefaultEvent(evt);
};

NaturalNumberInput.prototype.doDragEnter = function (evt) {
    Utils.stopDefaultEvent(evt);
};

NaturalNumberInput.prototype.doCompositionStart = function (evt) {
    this.cpl = true;
};

NaturalNumberInput.prototype.doCompositionEnd = function (evt) {
    this.cpl = false;
};

NaturalNumberInput.prototype.message = function (evt, cmd, msg) {
...
NaturalNumberInput.prototype.act = function (evt, cmd, o, e, val) {
    if (cmd == 1) {
        o.show("0"); // hidden
    } else if (cmd == 2) {
        o.show("1"); // show
        ...
        if (o instanceof NaturalNumberInput) {
            o.initValue = val;
            o.updateDom();
        }
...
NaturalNumberInput.prototype.fCmd = function (evt, r, e) {
...
NaturalNumberInput.prototype.tCmd = function (evt, r, e) {
...
NaturalNumberInput.prototype.doHandle = function (evt, cmd) {
    try {
        var e = document.getElementById("natural" + this.id);
...
NaturalNumberInput.prototype.doDragStart = function (evt) {
    if (this.evn == 0) {
        if (map[this.currOwner] != null
            && map[this.currOwner].currObject instanceof Form) {
...
NaturalNumberInput.prototype.doDrag = function (evt) {
    Utils.stopBubble(evt);
};

NaturalNumberInput.prototype.doDragEnd = function (evt) {
    if (this.evn == 0) {
        if (map[this.currOwner] != null
            && map[this.currOwner].currObject instanceof Form) {
...
NaturalNumberInput.prototype.parseFromJSON = function (json, evn) {
    this.id = json.id;
...
NaturalNumberInput.prototype.parseExpressions = function (owner) {
    for (var i = 0; i < this.rules.length; i++) {
        this.rules[i].parseExpressions(owner);
    }
};

NaturalNumberInput.prototype.toTree = function () {
    return {
        id: this.id,
        text: this.title,
        icon: "fa fa-file-text-o",
        data: "自然数（正整数）输入框|" + (this.initValue == null ? "" : this.initValue),
    }
};

NaturalNumberInput.prototype.fetchRuleByNum = function (number) {
...
NaturalNumberInput.prototype.toString = function () {
    return this.title == null ? "自然数（正整数）输入框" : this.title;
};

NaturalNumberInput.prototype.addRule = function (r) {
    this.rules.push(r);
};

NaturalNumberInput.prototype.insertRule = function (r, index) {
    this.rules.splice(index, 0, r);
};

NaturalNumberInput.prototype.removeRule = function (r) {
    for (var i = 0; i < this.rules.length; i++) {
        if (this.rules[i] == r) {
