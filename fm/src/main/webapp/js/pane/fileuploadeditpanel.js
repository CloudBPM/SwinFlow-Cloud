...
(function($, window, document, undefined) {
	var pluginName = "fileUploadEditPanel";
	var defaults = {
		id : "",
		parent : "",
		entity : "",
	...
	EditPanel.prototype.loadPane = function(entity, tabindex, owner) {
		...
		tabUL.id = "fup-input-props-nav-tabs";
		...
		var that = this;
		$("#fup-input-props-nav-tabs").on("click", "a", function(e) {
			e.preventDefault();
			$(this).tab('show');
		...
		var plugin1 = $(this.tabContent1).fileUploadPropPane({
			id : "tab0",
		...
		this.fileUploadPropPane = plugin1.data("fileUploadPropPane");
		...
		$('#fup-input-props-nav-tabs a[href="#tab' + this.currtabindex + '"]')
				.tab('show');
