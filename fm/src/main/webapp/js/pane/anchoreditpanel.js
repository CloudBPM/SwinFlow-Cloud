...
(function($, window, document, undefined) {
	var pluginName = "anchorEditPanel";
	var defaults = {
		id : "",
		parent : "",
		entity : "",
	...
	EditPanel.prototype.loadPane = function(entity, tabindex, owner) {
		...
		tabUL.id = "ach-input-props-nav-tabs";
		...
		var that = this;
		$("#ach-input-props-nav-tabs").on("click", "a", function(e) {
			e.preventDefault();
			$(this).tab('show');
		...
		var plugin1 = $(this.tabContent1).anchorPropPane({
			id : "tab0",
		...
		this.anchorPropPane = plugin1.data("anchorPropPane");
		...
		// by default
		$('#ach-input-props-nav-tabs a[href="#tab' + this.currtabindex + '"]')
				.tab('show');
