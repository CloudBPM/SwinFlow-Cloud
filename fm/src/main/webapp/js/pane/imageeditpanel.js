...
(function($, window, document, undefined) {
	...
	EditPanel.prototype.loadPane = function(entity, tabindex, owner) {
		...
		tabUL.id = "img-input-props-nav-tabs";
		...
		var that = this;
		$("#img-input-props-nav-tabs").on("click", "a", function(e) {
			e.preventDefault();
			$(this).tab('show');
		...
		var plugin1 = $(this.tabContent1).imagePropPane({
			id : "tab0",
		...
		this.imagePropPane = plugin1.data("imagePropPane");
		...
		// by default
		$('#img-input-props-nav-tabs a[href="#tab' + this.currtabindex + '"]')
				.tab('show');
