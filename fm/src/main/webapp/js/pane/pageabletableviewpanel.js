...
(function($, window, document, undefined) {
	var pluginName = "pageableTableViewPanel";
	var defaults = {
		id : "",
		parent : "",
		entity : "",
	...
	EditPanel.prototype.loadPane = function(entity, tabindex, owner) {
		...
		var plugin1 = $(this.tabContent1).pageableTableViewPropPane({
			id : "ptvtab0",
		...
		//this.pageableTableViewPropPane = plugin1.data("pageableTableViewPropPane");
