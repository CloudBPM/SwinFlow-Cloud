...
(function($, window, document, undefined) {
	var pluginName = "datetimeInputPanel";
	var defaults = {
		id : "",
		parent : "",
		entity : "",
	...
	EditPanel.prototype.loadPane = function(entity, tabindex, owner) {
		...
		tabUL.id = "dt-input-props-nav-tabs";
		...
		var that = this;
		$("#dt-input-props-nav-tabs").on("click", "a", function(e) {
			e.preventDefault();
			$(this).tab('show');
		...
		var plugin1 = $(this.tabContent1).datetimeInputPropPane({
			id : "dtetab0",
		...
		this.datetimeInputPropPane = plugin1.data("datetimeInputPropPane");
		...
		// by default
		$('#dte-input-props-nav-tabs a[href="#dtetab' + this.currtabindex + '"]').tab('show');
