...
(function($, window, document, undefined) {
	var pluginName = "largeButtonEditPanel";
	var defaults = {
		id : "",
		parent : "",
		entity : "",
	...
	EditPanel.prototype.loadPane = function(entity, tabindex, owner) {
		...
		tabUL.id = "lgbtn-input-props-nav-tabs";
		...
		var that = this;
		$("#lgbtn-input-props-nav-tabs").on("click", "a", function(e) {
			e.preventDefault();
			$(this).tab('show');
		...
		var plugin1 = $(this.tabContent1).largeButtonPropPane({
			id : "tab0",
		...
		this.largeButtonPropPane = plugin1.data("largeButtonPropPane");
		...
		$('#lgbtn-input-props-nav-tabs a[href="#tab' + this.currtabindex + '"]')
				.tab('show');
