...
(function($, window, document, undefined) {
	var pluginName = "multipleLineInputAssociatedPane";
	var defaults = {
		id : "",
		parent : "",
		entity : "",
	...
	AssociatedPropPanel.prototype.init = function(options) {
		...
		var plugin41 = $(this).textInputBehaviorSelectCellEditor({
			parent : this,
		});
		this.editor41 = plugin41.data("textInputBehaviorSelectCellEditor");
	...
	AssociatedPropPanel.prototype.loadData = function(entity, comptable) {
		...
		if (this.rules.length > 0) {
			for (var i = 0; i < this.rules.length; i++) {
				...
				this.createCell(1, textinputbehaviors[this.rules[i].behavior],
						row, "bh");
