...
(function($, window, document, undefined) {
	var pluginName = "staticListEditPanel";
	var defaults = {
		id : "",
		parent : "",
		entity : "",
	...
	EditPanel.prototype.loadPane = function(entity, tabindex, owner) {
		...
		tabUL.id = "slst-input-props-nav-tabs";
		...
		var that = this;
		$("#slst-input-props-nav-tabs").on("click", "a", function(e) {
			e.preventDefault();
			$(this).tab('show');
		...
		var plugin1 = $(this.tabContent1).staticListPropPane({
			id : "tab0",
		...
		this.staticListPropPane = plugin1.data("staticListPropPane");
		...
		$('#slst-input-props-nav-tabs a[href="#tab' + this.currtabindex + '"]')
				.tab('show');
