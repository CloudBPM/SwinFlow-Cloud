...
(function($, window, document, undefined) {
	var pluginName = "paragraphEditPanel";
	var defaults = {
		id : "",
		parent : "",
		entity : "",
	...
	EditPanel.prototype.loadPane = function(entity, tabindex, owner) {
		...
		tabUL.id = "p-input-props-nav-tabs";
		...
		var that = this;
		$("#p-input-props-nav-tabs").on("click", "a", function(e) {
			e.preventDefault();
			$(this).tab('show');
		...
		var plugin1 = $(this.tabContent1).paragraphPropPane({
			id : "tab0",
		...
		this.paragraphPropPane = plugin1.data("paragraphPropPane");
		...
		$('#p-input-props-nav-tabs a[href="#tab' + this.currtabindex + '"]')
				.tab('show');
