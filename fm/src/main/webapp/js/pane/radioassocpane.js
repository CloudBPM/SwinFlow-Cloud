...
(function($, window, document, undefined) {
	var pluginName = "radioAssociatedPane";
	var defaults = {
		id : "",
		parent : "",
		entity : "",
	...
	AssociatedPropPanel.prototype.init = function(options) {
		...
		var plugin41 = $(this).radioBehaviorSelectCellEditor({
			parent : this,
		});
		this.editor41 = plugin41.data("radioBehaviorSelectCellEditor");
	...
	AssociatedPropPanel.prototype.loadData = function(entity, comptable) {
		...
		if (this.rules.length > 0) {
			for (var i = 0; i < this.rules.length; i++) {
				...
				this.createCell(1, radiobehaviors[this.rules[i].behavior], row,
						"bh");
