package com.cloudibpm.blo.search;
...
public class SearchEngineCleaner {
	// solr 服务器地址
	public static final String solrServerUrl = "http://localhost:8080/search";
	// solrhome下的core
	public static final String solrMSCoreHome = "mycore";
	// solrhome下的core
	public static final String solrFrmCoreHome = "frmcore";
	// solrhome下的core
	public static final String solrProcCoreHome = "proccore";
	// 待索引、查询字段
...
//		solrDocs.add(doc);
		...
		try {
			...
			HttpSolrClient.Builder builder = new HttpSolrClient.Builder(solrServerUrl + "/" + solrMSCoreHome);
			SolrClient client = builder.build();
			client.deleteById("000000000000013I");
			//client.add(solrDocs);
			client.commit();
