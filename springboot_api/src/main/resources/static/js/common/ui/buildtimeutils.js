 ...
 * 
 */
function BuildTimeUtils() {
};

BuildTimeUtils.startIcon48x48 = function(context, x1, y1) {
...
BuildTimeUtils.startIcon32x32 = function(context, x1, y1) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
...
BuildTimeUtils.endIcon48x48 = function(context, x0, y0) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
...
BuildTimeUtils.endIcon32x32 = function(context, x0, y0) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
...
BuildTimeUtils.mobileIcon40x40 = function(context, x1, y1) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
	var cornerRadius = 4;
...
BuildTimeUtils.mobileSMSSendingIcon40x40 = function(context, x2, y2) {
...
BuildTimeUtils.mobileSMSReceivingIcon40x40= function(context, x2, y2) {
	mobileIcon40x40(context, x2, y2);
...
BuildTimeUtils.mobileIcon32x32= function(context, x2, y2) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
	var cornerRadius = 4;
...
BuildTimeUtils.mobileReceivingIcon32x32= function(context, x2, y2) {
...
BuildTimeUtils.mobileSendingIcon32x32= function(context, x2, y2) {
	mobileIcon32x32(context, x2, y2);
...
BuildTimeUtils.emailIcon32x32= function(context, x2, y2) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
...
BuildTimeUtils.emailReceivingIcon32x32= function(context, x2, y2) {
...
BuildTimeUtils.emailSendingIcon32x32= function(context, x2, y2) {
	emailIcon32x32(context, x2, y2);
...
BuildTimeUtils.mobile48x48= function(context, x2, y2) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
	var cornerRadius = 4;
...
BuildTimeUtils.mobile48x48Receiving= function(context, x2, y2) {
	BuildTimeUtils.mobile48x48(context, x2, y2);
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
	// SMS
...
// 48px x 48px mobile SMS receiving
BuildTimeUtils.mobile48x48SendingIcon = function(context, x2, y2) {
	BuildTimeUtils.mobile48x48(context, x2, y2);
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
...
BuildTimeUtils.email48x48Icon= function(context, x2, y2) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
	// evolope body
...
BuildTimeUtils.email48x48IconReceiving= function(context, x2, y2) {
	BuildTimeUtils.email48x48Icon(context, x2, y2);
...
BuildTimeUtils.email48x48IconSending= function(context, x2, y2) {
	BuildTimeUtils.email48x48Icon(context, x2, y2);
...
BuildTimeUtils.clockIcon48x48= function(context, x0, y0) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
	var radius = 24;
...
BuildTimeUtils.clockIcon32x32= function(context, x2, y2) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
	var radius = 15;
...
BuildTimeUtils.assignIcon48x48= function(context, x2, y2) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
...
BuildTimeUtils.assignIcon32x32= function(context, x2, y2) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
...
BuildTimeUtils.subProcessIcon48x48= function(context, x0, y0) {
	
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;

	this.startIcon48x48(context, x0, y0);
...
BuildTimeUtils.subProcessIcon32x32= function(context, x0, y0) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
...
BuildTimeUtils.manualTaskIcon32x32= function(context, x0, y0) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
	// suite
...
BuildTimeUtils.manualTaskIcon48x48= function(context, x0, y0) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
	// suite
...
BuildTimeUtils.gearIcon48x48= function(context, x0, y0) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
...
BuildTimeUtils.gearIcon32x32= function(context, x0, y0) {
	var tfs = context.fillStyle;
	var tss = context.strokeStyle;
	var lw = context.lineWidth;
	// Copyright (C) Ken Fyrstenberg / Epistemex
