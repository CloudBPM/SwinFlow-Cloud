...
(function($, window, document, undefined) {
	var pluginName = "readonlyTableViewer";
	var defaults = {
		id : "",
		ownerId : "",
		basicpropsheet : "",
	...
	ListViewPanel.prototype.init = function() {
		...
		editorPanel.id = "listPanel" + this.options.id;
		editorPanel.style.width = this.options.width + "px";
	...
	ListViewPanel.prototype.createToolbar = function() {
