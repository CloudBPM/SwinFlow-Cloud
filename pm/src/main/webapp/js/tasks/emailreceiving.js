...
function EmailReceivingTask() {
	...
	this.classtypename = "EmailReceivingTask";
	this.lastupdate = null;
};

EmailReceivingTask.prototype = new AbstractTask();

EmailReceivingTask.prototype.clone = function() {
	var a = new EmailReceivingTask();
	a.id = this.id;
	a.name = this.name;
...
EmailReceivingTask.prototype.stringifyforJSON = function() {
	var a = new EmailReceivingTask();
	a.id = this.id;
	a.name = this.name;
	a.x0 = this.x0; // top left corner X
...
EmailReceivingTask.prototype.parse = function(json) {
	this.id = json.id;
	this.name = json.name;
...
EmailReceivingTask.prototype.drawToContext = function() {
	...
	BuildTimeUtils.email48x48IconReceiving(this.context, this.x1 - 48, this.y1 - 48);
...
EmailReceivingTask.prototype.isInMark = function(x, y) {
