...
<head>
    ...
    <!-- CEditor plugin -->
    <script src="<%=staticUrl%>/api/plugins/ckeditor_4.5.11_ed010f407747/ckeditor/ckeditor.js"></script>
    <!-- JSTree plugin -->
    ...
    <script src="js/blmservice.js"></script>
    <script src="js/basicpropertysheet.js"></script>
    <script src="js/propertysheet.js"></script>
    <script src="js/blmmainmenubar.js"></script>
    <script src="js/blmmaincontent.js"></script>
...
<script>
    ...
    var service = new BLMService("<%=userid%>", "", "<%=sessionId%>");
    ...
    if (typeof(Storage) !== "undefined") {
        ...
        localStorage.setItem("currtab" + userId, "blm");
    ...
    //var statusbar = pmstatusbar.data("pmStatusBar");
