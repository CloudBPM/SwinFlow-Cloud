...
function EmailReceivingTaskInstance() {
	this.id = "Email Receiving 00"; // top left corner X
	this.name = "Email Receiving"; // top left corner Y
	...
	this.classtypename = "EmailReceivingTaskInstance";
...
EmailReceivingTaskInstance.prototype = new EmailReceivingTask();

EmailReceivingTaskInstance.prototype.clone = function() {
	var a = new EmailReceivingTaskInstance();
	a.id = this.id;
	a.name = this.name;
...
EmailReceivingTaskInstance.prototype.stringifyforJSON = function() {
	var a = new EmailReceivingTaskInstance();
	a.id = this.id;
	a.name = this.name;
	a.x0 = this.x0; // top left corner X
...
EmailReceivingTaskInstance.prototype.parse = function(json) {
	this.id = json.id;
	this.name = json.name;
...
EmailReceivingTaskInstance.prototype.drawToContext = function() {
	...
	email48x48IconReceiving(this.status, this.context, this.x1 - 48, this.y1 - 48);
...
EmailReceivingTaskInstance.prototype.isInMark = function(x, y) {
