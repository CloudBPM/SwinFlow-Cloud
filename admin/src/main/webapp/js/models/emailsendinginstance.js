...
function EmailSendingTaskInstance() {
	...
	this.classtypename = "EmailSendingTaskInstance";
...
EmailSendingTaskInstance.prototype = new EmailSendingTask();

EmailSendingTaskInstance.prototype.cloneReceiverList = function() {
	var parts = [];
...
EmailSendingTaskInstance.prototype.clone = function() {
	var a = new EmailSendingTaskInstance();
	a.id = this.id;
	a.name = this.name;
...
EmailSendingTaskInstance.prototype.stringifyforJSON = function() {
	var a = new EmailSendingTaskInstance();
	a.id = this.id;
	a.name = this.name;
	a.x0 = this.x0; // top left corner X
...
EmailSendingTaskInstance.prototype.parse = function(json) {
	this.id = json.id;
	this.name = json.name;
...
EmailSendingTaskInstance.prototype.drawToContext = function() {
	...
	email48x48IconSending(this.status, this.context, this.x1 - 48, this.y1 - 48);
...
EmailSendingTaskInstance.prototype.isInMark = function(x, y) {
