...
function SMSReceivingTaskInstance() {
	...
	this.classtypename = "SMSReceivingTaskInstance";
...
SMSReceivingTaskInstance.prototype = new SMSReceivingTask();

SMSReceivingTaskInstance.prototype.clone = function() {
...
SMSReceivingTaskInstance.prototype.stringifyforJSON = function() {
	var a = new SMSReceivingTaskInstance();
	a.id = this.id;
	a.name = this.name;
	a.x0 = this.x0; // top left corner X
	a.y0 = this.y0; // top left corner Y
...
SMSReceivingTaskInstance.prototype.parse = function(json) {
	this.id = json.id;
	this.name = json.name;
...
SMSReceivingTaskInstance.prototype.drawToContext = function() {
	...
	mobile48x48Receiving(this.status, this.context, this.x1 - 48, this.y1 - 48);
...
SMSReceivingTaskInstance.prototype.isInMark = function(x, y) {
