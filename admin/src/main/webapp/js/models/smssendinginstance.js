...
function SMSSendingTaskInstance() {
...
SMSSendingTaskInstance.prototype = new SMSSendingTask();

SMSSendingTaskInstance.prototype.cloneReceiverList = function() {
	var parts = [];
...
SMSSendingTask.prototype.clone = function() {
	var a = new SMSSendingTaskInstance();
	a.id = this.id;
	a.name = this.name;
...
SMSSendingTaskInstance.prototype.stringifyforJSON = function() {
	var a = new SMSSendingTaskInstance();
	a.id = this.id;
	a.name = this.name;
	a.x0 = this.x0; // top left corner X
...
SMSSendingTaskInstance.prototype.parse = function(json) {
	this.id = json.id;
	this.name = json.name;
...
SMSSendingTaskInstance.prototype.drawToContext = function() {
	...
	mobile48x48SendingIcon(this.status, this.context, this.x1 - 48, this.y1 - 48);
...
SMSSendingTaskInstance.prototype.isInMark = function(x, y) {
