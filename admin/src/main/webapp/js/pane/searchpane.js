...
(function ($, window, document, undefined) {
    ...
    SearchConditionPanel.prototype.init = function (options) {
        ...
        modalframe.id = "searchAllPane" + options.pid;
        ...
        this.searchInput.setAttribute("placeholder",
            "搜索条件可以是应用实例标识、应用定义标识、应用名称、版本号、关键字、发起人姓名、发起人证件号等）");
    ...
    SearchConditionPanel.prototype.createToolbar = function (options, toolbar) {
        ...
        // this.startbutton = this.createTool(g4, "start"
        // + this.options.id, "启动一个实例", c, "i", "fa fa-car fa-lg");
    ...
    SearchConditionPanel.prototype.doClick = function (evt) {
        if (evt.target == this.firstPageHButton
            ...
            this.loading(this.options.owner, 1, 30,
            ...
            this.loading(this.options.owner, this.currpage.pageNo - 1, 30,
                this.searchInput.value, this.statusSelect.value,
                this.fromDateInput.value, this.toDateInput.value);
            ...
            this.loading(this.options.owner, this.currpage.allPagesCount, 30,
                this.searchInput.value, this.statusSelect.value,
                this.fromDateInput.value, this.toDateInput.value);
            ...
            // var that = this;
            // $.post(service.api(2), {
            // pid : "00000000000001AH",// process ID
    ...
    SearchConditionPanel.prototype.loading = function (oid, pageno, pagesize,
