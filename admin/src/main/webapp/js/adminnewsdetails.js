...
(function($, window, document, undefined) {
	var pluginName = "adminNewsDetails";
	var defaults = {
		id : "", // process ID
		basicpropsheet : "",
		propsheet : "",
	...
	Editor.prototype.init = function(options) {
		...
		canvasPanel.id = "newsDetails" + options.id;
	...
	Editor.prototype.doChangeContent = function() {
		map[this.currObject.id].stack.execute(new ADMINCKEditorCotentChangedCmd(
				this.currObject, this.currObject.id));
	};
	...
	Editor.prototype.doChange = function(evt) {
		...
		if (newvalue != oldvalue) {
			map[this.currObject.id].stack.execute(new ADMINValueChangedCmd(
					this.currObject, "title", newvalue, this.currObject.id));
		} else {
