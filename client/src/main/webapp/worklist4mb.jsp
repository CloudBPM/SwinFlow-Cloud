...
<head>
    ...
    <script src="js/pane/workitemlisttabpanel4mb.js"></script>
...
<script>
    ...
    if ($(mainContent).myWorkListPanelforMobile != undefined) {
        var board = $(mainContent).myWorkListPanelforMobile({
            id : "workItemPane00011",
            uid : "<%=userid%>",
            parent : this,
            topparent : this,
            source : 0,
        ...
        this.myWorkListPanelforMobile = board.data("myWorkListPanelforMobile");
    }
    ...
    this.myWorkListPanelforMobile.bench = this.workbench;
    this.workbench.worklist = this.myWorkListPanelforMobile;
    this.myWorkListPanelforMobile.show(true);
