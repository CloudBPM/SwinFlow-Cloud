...
(function ($, window, document, undefined) {
    var pluginName = "myWorkListPanelforMobile";
    var defaults = {
        id : "",
        parent : "",
        uid : "",
    ...
    ListPane.prototype.init = function (options) {
        ...
        tabUL.className = "nav nav-tabs worklist-nav-tabs";
        ...
        $('#worklist-input-nav-tabs a[href="#itemtab' + this.currtabindex + '"]').tab('show');
    ...
    ListPane.prototype.newTabHead = function (parent, index, caption, active) {
        ...
        tabLink.setAttribute("href", "#itemtab" + index);
        tabLink.setAttribute("aria-controls", "itemtab" + index);
    ...
    ListPane.prototype.show = function(show) {
        if (show) {
            this.refresh();
            this.modalframe.style.display = "";
        } else {
    ...
    ListPane.prototype.setBadage = function (parent, num) {
        if (num != 0 && num != "0" && num != "") {
            parent.lastChild.innerHTML = num;
        } else {
    ...
    ListPane.prototype.newTabContent = function (parent, index, active) {
        ...
        tabContent.setAttribute("data", "itemtab" + index);
        tabContent.setAttribute("role", "tabpanel");
        if (active)
            tabContent.className = "tab-pane active";
        else
            tabContent.className = "tab-pane";
        tabContent.id = "itemtab" + index;
        return tabContent;
    };
