/**
 * java -jar ./antlr-4.7-complete.jar -visitor -no-listener ConditionalExpression.g4
 * 
 */
...
expression 
    ...
    |    '!' expression                                         #Not
    |   op=('+'|'-') expression                                 #PositiveNegative
    |   expression op=('*'|'/'|'%') expression                  #MulDivMod
	|   expression op=('+'|'-') expression                      #AddSub
    |   expression op=('>'|'>='|'<'|'<='|'=='|'!=')  expression #Comparative
