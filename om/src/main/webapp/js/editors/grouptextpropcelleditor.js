...
(function($, window, document, undefined) {
	var pluginName = "authGroupTextPropCellEditor";
	var defaults = {
		parent : "",
		msg : "",
	};

	var GroupTextPropCellEditor = function(element, options) {
	...
	GroupTextPropCellEditor.prototype.loadEditor = function(tabid, tag, entity,
			prop, isnull) {
		var that = this;
		this.tabId = tabid;
		if ($(tag).attr("type") == "h") {
	...
	GroupTextPropCellEditor.prototype.changeValue = function(tag, entity, prop,
			oldvalue, isnull) {
	...
	$.fn[pluginName] = function(options) {
		return this.each(function() {
			if (!$.data(this, pluginName)) {
				$.data(this, pluginName, new GroupTextPropCellEditor(this,
						options));
