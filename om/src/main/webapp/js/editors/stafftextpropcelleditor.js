...
(function($, window, document, undefined) {
	var pluginName = "staffTextPropCellEditor";
	var defaults = {
		parent : "",
		msg : "",
	};

	var StaffTextPropCellEditor = function(element, options) {
	...
	StaffTextPropCellEditor.prototype.loadEditor = function(tabid, tag, entity,
			prop, isnull) {
		var that = this;
		this.tabId = tabid;
		if ($(tag).attr("type") == "h") {
	...
	StaffTextPropCellEditor.prototype.changeValue = function(tag, entity, prop,
			oldvalue, isnull) {
	...
	$.fn[pluginName] = function(options) {
		return this.each(function() {
			if (!$.data(this, pluginName)) {
				$.data(this, pluginName, new StaffTextPropCellEditor(this,
						options));
