...
(function ($, window, document, undefined) {
    var pluginName = "desktopIconNameCellEditor";
    var defaults = {
        parent: "",
        msg: "",
    };

    var IconNameCellEditor = function (element, options) {
    ...
    IconNameCellEditor.prototype.loadEditor = function (tabid, tag, entity,
                                                        prop, isnull) {
        var that = this;
        this.tabId = tabid;
        if ($(tag).attr("type") == "h") {
    ...
    IconNameCellEditor.prototype.changeValue = function (tag, entity, prop,
                                                         oldvalue, isnull) {
        ...
        return this
            .each(function () {
                if (!$.data(this, pluginName)) {
                    $.data(this, pluginName, new IconNameCellEditor(this,
                        options));
