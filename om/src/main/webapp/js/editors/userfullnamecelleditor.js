...
(function($, window, document, undefined) {
	var pluginName = "userFullNameCellEditor";
	var defaults = {
		parent : "",
		msg : "",
	};

	var FullNameCellEditor = function(element, options) {
	...
	FullNameCellEditor.prototype.loadEditor = function(tabid, tag, entity,
			prop, isnull) {
		var that = this;
		this.tabId = tabid;
		if ($(tag).attr("type") == "h") {
	...
	FullNameCellEditor.prototype.changeValue = function(tag, entity, prop,
			oldvalue, isnull) {
		...
		return this
				.each(function() {
					if (!$.data(this, pluginName)) {
						$.data(this, pluginName, new FullNameCellEditor(this,
								options));
