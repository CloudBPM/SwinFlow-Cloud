...
(function($, window, document, undefined) {
	...
	TextCellEditor.prototype.loadEditor = function(tag, entity, prop, isnull) {
		...
		$(tag).text("");
		// var inputObj = $("<input type='text' style='border: 0'/>");
		// inputObj.css("background-color", "white").css("font-size",
		// $(tag).css("font-size")).css("width",
		// parseInt($(tag).css("width"))).val(oldvalue).appendTo($(tag))
		// .get(0).select();
		// css("height",parseInt($(entity).css("height")) - 16).
