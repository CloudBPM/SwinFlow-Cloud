...
(function($, window, document, undefined) {
	var pluginName = "userTextPropCellEditor";
	var defaults = {
		parent : "",
		msg : "",
	};

	var UserTextPropCellEditor = function(element, options) {
	...
	UserTextPropCellEditor.prototype.loadEditor = function(tabid, tag, entity,
			prop, isnull) {
		var that = this;
		this.tabId = tabid;
		if ($(tag).attr("type") == "h") {
	...
	UserTextPropCellEditor.prototype.changeValue = function(tag, entity, prop,
			oldvalue, isnull) {
	...
	$.fn[pluginName] = function(options) {
		return this.each(function() {
			if (!$.data(this, pluginName)) {
				$.data(this, pluginName, new UserTextPropCellEditor(this,
						options));
