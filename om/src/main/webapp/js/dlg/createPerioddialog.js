...
(function($, window, document, undefined) {
    var pluginName = "createPeriodDialog";
    var defaults = {
        id : "",
        title : "",
    ...
    ConfirmDialog.prototype.init = function(options) {
        ...
        this.dialogOneBody = document.createElement("span");
        this.dialogOneBody.innerText = "开始时间:";
        dialogBodyDIV.appendChild(this.dialogOneBody);

        this.dialogOneTime = document.createElement("input");
        this.dialogOneTime.type = "time";
        this.dialogOneTime.id = "beginTime";
        this.dialogOneTime.style.marginLeft = "20px";
        dialogBodyDIV.appendChild(this.dialogOneTime);

        this.dialogTwoBody = document.createElement("span");
        this.dialogTwoBody.innerText = "结束时间:";
        this.dialogTwoBody.style.marginLeft = "40px";
        dialogBodyDIV.appendChild(this.dialogTwoBody);

        this.dialogTwoTime = document.createElement("input");
        this.dialogTwoTime.type = "time";
        this.dialogTwoTime.id = "endTime";
        this.dialogTwoTime.style.marginLeft = "20px";
        dialogBodyDIV.appendChild(this.dialogTwoTime);
    ...
    ConfirmDialog.prototype.doClick = function(evt) {
        ...
        if (evt.target.id == "YESButton" + this.options.id) {
            this.options.parent.doYesAction(evt,this.dialogOneTime.value,this.dialogTwoTime.value,null,this.oid,"2");
        }else {
