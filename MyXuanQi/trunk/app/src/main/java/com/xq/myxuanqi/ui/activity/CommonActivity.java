...
import com.xq.myxuanqi.util.AndroidToJS;
...
public class CommonActivity extends BaseActivity {
    ...
    public void init() {
        ...
        //参数1：Javascript对象名
        //参数2：Java对象名
        mWeb.addJavascriptInterface(new AndroidToJS(this), "android");//AndroidtoJS类对象映射到js的test对象
...
//                tv.setText(path);
                Toast.makeText(CommonActivity.this, mPath+"222222", Toast.LENGTH_SHORT).show();
            }
        }
    }
