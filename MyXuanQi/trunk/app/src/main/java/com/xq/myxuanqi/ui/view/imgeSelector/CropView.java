...
public class CropView extends View {
    ...
    public CropView setRadius(float radius) {
        this.radius = radius;
        post(new Runnable() {
            @Override
            public void run() {
    ...
    public CropView setMaskColor(@ColorInt int maskColor) {
    ...
    public CropView setBorderColor(@ColorInt int borderColor) {
    ...
    public CropView setMaxScale(float maxScale) {
        if(maxScale<1){
            maxScale=1;
        }
    ...
    public CropView setDoubleClickScale(float doubleClickScale) {
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.CropView);
        maskColor = typedArray.getColor(R.styleable.CropView_maskColor, Color.parseColor("#60000000"));
        borderColor = typedArray.getColor(R.styleable.CropView_borderColor, ContextCompat.getColor(getContext(),android.R.color.white));
        radius = typedArray.getDimension(R.styleable.CropView_radius, -1);

        maxScale = typedArray.getFloat(R.styleable.CropView_maxScale, 3f);
        doubleClickScale = typedArray.getFloat(R.styleable.CropView_doubleClickScale, 1.8f);
...
/*    private void Log(String s) {
    ...
    /*******************************************************************************************************/
    public CropView setBitmap(int resId, int reqWidth, int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmap(getContext(),resId,reqWidth,reqHeight);
        return this;
    }
    public CropView setBitmap(String pathName, int reqWidth, int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmap(pathName,reqWidth,reqHeight);
        return this;
    }
    /*针对相册图片旋转新增一个方法*/
    public CropView setBitmapToRotate(String pathName, int reqWidth, int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmap(pathName,reqWidth,reqHeight);
    ...
    public CropView setBitmap(byte[] data, int offset, int length, int reqWidth, int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmap(data,offset,length,reqWidth,reqHeight);
        return this;
    }
    public CropView setBitmap(FileDescriptor fd, Rect outPadding, int reqWidth, int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmap(fd,outPadding,reqWidth,reqHeight);
        return this;
    }
    public CropView setBitmap(Resources res, TypedValue value, InputStream is, Rect pad, int reqWidth, int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmap(res,value,is,pad,reqWidth,reqHeight);
        return this;
    }
    public CropView setBitmap(InputStream is, Rect outPadding, int reqWidth, int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmap(is,outPadding,reqWidth,reqHeight);
        return this;
    }
    /*******************************************************************************************************/
    ...
    /*******************************************************************************************************/
    public CropView setBitmapForHeight(int resId,int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmapForHeight(getContext(),resId,reqHeight);
        return this;
    }
    public CropView setBitmapForHeight(String pathName, int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmapForHeight(pathName,reqHeight);
        return this;
    }
    /*针对相册图片旋转新增一个方法*/
    public CropView setBitmapForHeightToRotate(String pathName, int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmapForHeight(pathName,reqHeight);
        int degree = readPictureDegree(pathName);
        if(degree>0){
            showBitmap=rotateBitmap(degree,showBitmap);
    ...
    public CropView setBitmapForHeight(byte[] data, int offset, int length,int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmapForHeight(data,offset,length,reqHeight);
        return this;
    }
    public CropView setBitmapForHeight(FileDescriptor fd, Rect outPadding, int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmapForHeight(fd,outPadding,reqHeight);
        return this;
    }
    public CropView setBitmapForHeight(Resources res, TypedValue value, InputStream is, Rect pad, int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmapForHeight(res,value,is,pad,reqHeight);
        return this;
    }
    public CropView setBitmapForHeight(InputStream is, Rect outPadding, int reqHeight) {
        showBitmap= CropViewUtils2.compressBitmapForHeight(is,outPadding,reqHeight);
        return this;
    }
    /*******************************************************************************************************/
    ...
    /*******************************************************************************************************/
    public CropView setBitmapForWidth( int resId, int reqWidth) {
        showBitmap= CropViewUtils2.compressBitmapForWidth(getContext(),resId,reqWidth);
        return this;
    }
    public CropView setBitmapForWidth(String pathName, int reqWidth) {
        showBitmap= CropViewUtils2.compressBitmapForWidth(pathName,reqWidth);
        return this;
    }
    /*针对相册图片旋转新增一个方法*/
    public CropView setBitmapForWidthToRotate(String pathName, int reqWidth) {
        showBitmap= CropViewUtils2.compressBitmapForWidth(pathName,reqWidth);
        int degree = readPictureDegree(pathName);
        if(degree>0){
            showBitmap=rotateBitmap(degree,showBitmap);
    ...
    public CropView setBitmapForWidth(byte[] data, int offset, int length, int reqWidth) {
        showBitmap= CropViewUtils2.compressBitmapForWidth(data,offset,length,reqWidth);
        return this;
    }
    public CropView setBitmapForWidth(FileDescriptor fd, Rect outPadding, int reqWidth) {
        showBitmap= CropViewUtils2.compressBitmapForWidth(fd,outPadding,reqWidth);
        return this;
    }
    public CropView setBitmapForWidth(Resources res, TypedValue value, InputStream is, Rect pad, int reqWidth) {
        showBitmap= CropViewUtils2.compressBitmapForWidth(res,value,is,pad,reqWidth);
        return this;
    }
    public CropView setBitmapForWidth(InputStream is, Rect outPadding, int reqWidth) {
        showBitmap= CropViewUtils2.compressBitmapForWidth(is,outPadding,reqWidth);
        return this;
    }
    /*******************************************************************************************************/
    ...
    /*******************************************************************************************************/
    public CropView setBitmapForScale(int resId,int scaleSize) {
        showBitmap= CropViewUtils2.compressBitmapForScale(getContext(),resId,scaleSize);
        return this;
    }
    public CropView setBitmapForScale(String pathName, int scaleSize) {
        showBitmap= CropViewUtils2.compressBitmapForScale(pathName,scaleSize);
        return this;
    }
    /*针对相册图片旋转新增一个方法*/
    public CropView setBitmapForScaleToRotate(String pathName, int scaleSize) {
        showBitmap= CropViewUtils2.compressBitmapForScale(pathName,scaleSize);
        int degree = readPictureDegree(pathName);
        if(degree>0){
            showBitmap=rotateBitmap(degree,showBitmap);
    ...
    public CropView setBitmapForScale(byte[] data, int offset, int length,int scaleSize) {
        showBitmap= CropViewUtils2.compressBitmapForScale(data,offset,length,scaleSize);
        return this;
    }
    public CropView setBitmapForScale(FileDescriptor fd, Rect outPadding, int scaleSize) {
        showBitmap= CropViewUtils2.compressBitmapForScale(fd,outPadding,scaleSize);
        return this;
    }
    public CropView setBitmapForScale(Resources res, TypedValue value, InputStream is, Rect pad, int scaleSize) {
        showBitmap= CropViewUtils2.compressBitmapForScale(res,value,is,pad,scaleSize);
        return this;
    }
    public CropView setBitmapForScale(InputStream is, Rect outPadding, int scaleSize) {
        showBitmap= CropViewUtils2.compressBitmapForScale(is,outPadding,scaleSize);
        return this;
    }
    /*******************************************************************************************************/
